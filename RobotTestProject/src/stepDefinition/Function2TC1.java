...
//	    driver.findElement(By.id("register-email")).sendKeys("haris.situmeang.1412@gmail.com");
//	    driver.findElement(By.id("register-confirm-email")).sendKeys("haris.situmeang.1412@gmail.com");
